...
class menunikkiclub extends StatelessWidget{
	...
	const menunikkiclub ({Key key, this.barcodeScanRes}) : super(key: key);
										...
										children: <Widget>[
											...
											new Expanded(
												...
												child: new Container(
													child: new MaterialButton(child: Image.asset("lib/img/EstrellaConsultarPuntos.png",width: 300),
														onPressed: (){
															nikkiclub c1 = new nikkiclub();
															Cliente cliente = c1.getCliente();
															print(cliente.getNumeroTrjeta().toString());
															/*Navigator.push(
																context,
